...
import styles from './stryles.module.scss';
      ...
      <div className={styles.workNames}>
        {works.map((work, index) => (
          <button
            ...
            key={index}
            className={`${styles.workNamesSection}${workName}`}
            type="button"
        ...
        <div className={styles.workInfo}>
          ...
          <ul className={styles.workInfoDescription}>
            ...
            <li>
              ...
              embeddable web player widget for in-browser user authorization and full song
              playback
            </li>
            <li>
